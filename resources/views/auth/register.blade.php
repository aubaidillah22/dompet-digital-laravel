...
@section('title', 'Daftar - Dompet Digital')
...
<div class="auth-container">
    <div class="auth-card">
        ...
        <div class="auth-header">
            <div class="auth-icon-wrap"><i class="fas fa-user-plus"></i></div>
            <h1>Daftar Akun</h1>
        ...
        <form method="POST" action="{{ url('/register') }}" id="registerForm">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="full_name" required placeholder="Masukkan nama lengkap" value="{{ old('full_name') }}">
            </div>
            <div class="form-group">
                <label><i class="fas fa-user"></i> Username</label>
                <input type="text" class="form-control" name="username" required minlength="3" placeholder="Minimal 3 karakter" value="{{ old('username') }}">
            </div>
            <div class="form-group">
        ...
        <div class="footer-text">
            Sudah punya akun? <a href="{{ url('/login') }}" class="auth-link">Login di sini</a>
        </div>
    </div>
</div>
